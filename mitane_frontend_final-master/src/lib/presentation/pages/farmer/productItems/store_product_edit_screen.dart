...
class StoreProductEdit extends StatefulWidget {
  ...
  StoreProductEdit({required this.argument});

  @override
  _StoreProductEditState createState() => _StoreProductEditState();
}
...
class _StoreProductEditState extends State<StoreProductEdit> {
  ...
  void initState() {
    ...
    storeBloc.editImage = widget.argument.productItem.image;
