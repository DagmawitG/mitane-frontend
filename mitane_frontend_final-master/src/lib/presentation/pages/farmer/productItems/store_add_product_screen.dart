...
class StoreProductAdd extends StatefulWidget {
  static const String routeName = '/store/products/add';

  @override
  _StoreProductAddState createState() => _StoreProductAddState();
}

class _StoreProductAddState extends State<StoreProductAdd> {
                          ...
                          BlocListener<StoreBloc, StoreState>(
                            ...
                            listener: (context, state) {
                              ...
                              if (state is StoreItemAdded) {
                                context
                                    .read<StoreBloc>()
                                    .add(FetchStore(FETCHITEM.PRODUCT));
