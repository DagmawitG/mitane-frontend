...
class StoreMachinaryEdit extends StatefulWidget {
  final MachineryItem machineryItem;
  final String storeId;
  StoreMachinaryEdit({required this.machineryItem, required this.storeId});

  @override
  _StoreMachinaryEditState createState() => _StoreMachinaryEditState();
}

class _StoreMachinaryEditState extends State<StoreMachinaryEdit> {
  ...
  void initState() {
    ...
    storeBloc.editImage = widget.machineryItem.image;
                                      ...
                                      children: [
                                        ...
                                        BlocBuilder<StoreBloc, StoreState>(
                                          ...
                                          if (state is StoreFetchFailed) {
                                            return Text(
                                                'Error_ Displaying_ products_ list'
                                                    .tr());
                                          }
