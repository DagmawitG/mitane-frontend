...
class StoreMachinaryAdd extends StatefulWidget {
  @override
  _StoreMachinaryAddState createState() => _StoreMachinaryAddState();
}

class _StoreMachinaryAddState extends State<StoreMachinaryAdd> {
