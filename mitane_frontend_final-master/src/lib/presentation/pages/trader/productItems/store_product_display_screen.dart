...
import 'package:mitane_frontend/presentation/pages/trader/productItems/store_add_product_screen.dart';
import 'package:mitane_frontend/presentation/pages/trader/productItems/store_product_edit_screen.dart';
import 'package:mitane_frontend/route_generator.dart';
import 'package:easy_localization/easy_localization.dart';

class TraderStoreProductDisplay extends StatefulWidget {
  ...
  @override
  _TraderStoreProductDisplayState createState() =>
      _TraderStoreProductDisplayState();
}

class _TraderStoreProductDisplayState extends State<TraderStoreProductDisplay> {
  @override
  void initState() {
    super.initState();
          ...
          if (state is StoreFetched) {
            ...
            if (productItems.length == 0) {
              return EmptyResult(
                ...
                description:
                    "You don't have a product item in your store right now. you can create a product below!",
                btntxt: 'Create Product',
                onTap: () => Navigator.of(context).pushNamed(
                  TraderStoreProductAdd.routeName,
                ),
              );
            }
                    ...
                    child: Dismissible(
                        ...
                        confirmDismiss: (direction) async {
                          if (direction == DismissDirection.endToStart) {
                            ...
                            TraderStoreProductDisplay.editArgument =
                                productItems.elementAt(index);
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => TraderStoreProductEdit(
