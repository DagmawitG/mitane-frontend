...
class TraderStoreMachineryAdd extends StatefulWidget {
  static const String routeName = '/trader/store/machineries/add';

  @override
  _TraderStoreMachineryAddState createState() =>
      _TraderStoreMachineryAddState();
}

class _TraderStoreMachineryAddState extends State<TraderStoreMachineryAdd> {
                        ...
                        listener: (context, state) {
                          if (state is StoreItemAddFailed) {
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                content:
                                    Text("Error_ occured _while_ trying _to _add_ product".tr())));
                          }
                          ...
                          InkWell(
                              onTap: () {
                                ...
                                if (form != null && form.validate()) {
                                  ...
                                  MachineryItem item = MachineryItem(
                                      null,
                                      selectedValue!,
                                      ...
                                      null);
                                  print(
                                      "priceTextController ${item.pricerPerPiece}");

                                  final StoreEvent event =
                                      MachineryItemCreate(item);
