...
class TraderStoreIngredientEdit extends StatefulWidget {
  static const String routeName = 'trader/store/ingredients/edit';

  final IngridentItem ingredientItem;
  final String storeId;
  TraderStoreIngredientEdit(
      {required this.ingredientItem, required this.storeId});

  @override
  _TraderStoreIngredientEditState createState() =>
      _TraderStoreIngredientEditState();
}

class _TraderStoreIngredientEditState extends State<TraderStoreIngredientEdit> {
                    ...
                    listener: (context, state) {
                      if (state is StoreItemUpdatedFailed) {
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            content: Text("Error_ occured_ while_ trying_ to_ add_ product".tr())));
                      }
                                ...
                                children: [
                                  ...
                                  Material(
                                    ...
                                    child: TextFormField(
                                        ...
                                        validator: (value) {
                                          if (value != null && value.isEmpty) {
                                            return 'Please_ enter_ the_ price _per _unit'.tr();
                                          }
                                          return null;
                                        },
                                        onSaved: (value) {
