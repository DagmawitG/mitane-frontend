                              ...
                              children: [
                                      ...
                                      Material(
                                        ...
                                        child: TextFormField(
                                            ...
                                            validator: (value) {
                                              if (value != null &&
                                                  value.isEmpty) {
                                                return 'Please_ enter_ product_ name'.tr();
                                              }
                                              return null;
                                            },
                                            onSaved: (value) {
                                            ...
                                            children: [
                                              ...
                                              BlocBuilder<ProductBloc,
                                                ...
                                                if (state
                                                  ...
                                                  return Text(
                                                      'Error_ Displaying_ categories_ list'.tr());
                                                }
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                        onTap: () {
                                          print(widget.argument.product.name);
