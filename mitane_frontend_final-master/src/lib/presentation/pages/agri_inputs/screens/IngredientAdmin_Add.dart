                                  ...
                                  Material(
                                    ...
                                    child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          labelText: "Ingredient_ Name".tr(),
                                          border: OutlineInputBorder(),
                                        ),
                                        validator: (value) {
                                          if (value != null && value.isEmpty) {
                                            return 'Please_ enter_ ingredient_ name'
                                                .tr();
                                          }
                                          return null;
                                        },
