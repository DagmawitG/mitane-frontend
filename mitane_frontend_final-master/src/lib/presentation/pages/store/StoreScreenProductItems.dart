...
class StoreProductDisplayAll extends StatefulWidget {
  static const String routeName = '/stores/store/productItems';

  @override
  _StoreProductDisplayAllState createState() => _StoreProductDisplayAllState();
}

class _StoreProductDisplayAllState extends State<StoreProductDisplayAll> {
  ...
  void fetchProduct(
    ...
    BlocProvider.of<StoreBloc>(context).add(FetchProductStoreSorted(
    ...
    return MainLayOutListingWoFB(
      ...
      children: <Widget>[
        Expanded(child: BlocBuilder<StoreBloc, StoreState>(builder: (_, state) {
          ...
          if (state is StoreProductSortedFetched) {
            final productItems = state.storeProducts;
                ...
                itemBuilder: (_, int index) {
                  ...
                  return Container(
                    ...
                    child: StoreProductCard(
                        ...
                        productName: productItem.product.product.name,
                        quantity: productItem.product.quantity.toString(),
                        category: productItem.product.product.category,
                        image: productItem.product.image,
                        price:
                            productItem.product.pricerPerKg.toStringAsFixed(2)),
                  );
                });
          }
          return Center(
