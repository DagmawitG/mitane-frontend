                                ...
                                child: TextFormField(
                                  ...
                                  validator: (String? val) {
                                    if (val == null || val.isEmpty)
                                      return "Group_ is_ Required".tr();
                                  },
                                  textAlign: TextAlign.left,
                                  decoration: InputDecoration(
                                    labelText: "Group_ Name".tr(),
              ...
              BlocBuilder<TeamBloc, TeamState>(
                  ...
                  builder: (context, state) {
                    ...
                    if (state is TeamLocationError) {
                      return Center(child: Text("Please_ Enbale_ laocation".tr()));
                    }
                    if (state is TeamAdded) {
                      return Container(
                        child: Text('Team_ created'.tr()),
                      );
                    }
                    ...
                    return GestureDetector(
                      onTap: () {
                        if (form.currentState!.validate()) {
                          _teamBloc.add(AddTeam(nameController.text));
                        }
                      },
                      child: Container(
