              ...
              Expanded(
                child: Container(
                  ...
                  child: ListView(
                    children: [
                      TeamStat(),
                      TeamSection(title: "Teams_ created".tr(), child: TeamICreated()),
                      TeamSection(title: "Teams_ Joined".tr(), child: TeamJoined()),
                      TeamSection(title: "Near_ By_ team".tr(), child: TeamsNearBy()),
                    ],
                  ),
                ),
              ),
            ...
            children: [
              Expanded(
                child: Container(
                  ...
                  child: Column(children: [
                    Text("Joined_ Teams".tr().toUpperCase(),
              ...
              Expanded(
                child: Container(
                  ...
                  child: Column(children: [
                    Text("Team_ created".tr().toUpperCase(),
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<TeamBloc, TeamState>(builder: (context, state) {
      ...
      if (state is TeamFetchEmpty) {
        return EmptyResult(
            title: "Opps_ No_ team_ yet".tr(),
            description: "You_ don't_ have_ a_ team_ of_ your_ own_ right_ now_ you_ can_ create_ a_ team_ below".tr(),
            btntxt: 'Create Team',
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<TeamBloc, TeamState>(
        ...
        builder: (context, state) {
          ...
          if (state is TeamFetchEmpty) {
            return EmptyResult(
                title: "pps_No_ team_ yet".tr(),
                description: "You_ don't_ have_ a_ team_ of_ your_ own_ right_ now_ you_ can_ create_ a_ team_ below".tr(),
                btntxt: 'Create_ Team'.tr(),
                onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => TeamCreate()),
                    ));
