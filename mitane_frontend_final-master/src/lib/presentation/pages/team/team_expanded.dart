                ...
                listener: (context, state) {
                  ...
                  if (state is TeamDeleted) {
                    ...
                    ScaffoldMessenger.of(context)
                        .showSnackBar(SnackBar(content: Text("Team_ Deleted").tr()));
                  }
                  ...
                  if (state is TeamLeaved) {
                    Navigator.of(context).pop();
                    ScaffoldMessenger.of(context)
                        .showSnackBar(SnackBar(content: Text("You_ leaved_ the_ Team".tr())));
                  }
                  if (state is TeamAdded) {
                    ...
                    ScaffoldMessenger.of(context)
                        .showSnackBar(SnackBar(content: Text("You_ joined_ the_ Team".tr())));
                  }
                },
                child: Container(),
              ),
                          ...
                          children: [
                            ...
                            Text(team.name,
                                style: TextStyle(
                                    ...
                                    fontWeight: FontWeight.bold,
                                    fontSize: 32)),
                            Text("${team.users.length}" + "People".tr(),
                                style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 18,
                                    color: Colors.white)),
