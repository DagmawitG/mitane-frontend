...
class StoreProductSortedFetched extends StoreState {
  final List<StoreProduct> storeProducts;

  const StoreProductSortedFetched(this.storeProducts);
}

class StoreMachinerySortedFetched extends StoreState {
  final List<StoreMachinery> storeMachinery;

  const StoreMachinerySortedFetched(this.storeMachinery);
}

class StoreIngridentSortedFetched extends StoreState {
  final List<StoreIngrident> storeIngrident;

  const StoreIngridentSortedFetched(this.storeIngrident);
}
...
class ImagePicked extends StoreState {
  File file;
  ImagePicked(this.file);
}

class ImagePickedFailed extends StoreState {
  String msg;
  ImagePickedFailed(this.msg);
}

class ImagePickedClear extends StoreState {}
