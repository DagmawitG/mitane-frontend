...
class ProductItem {
  ...
  ProductItem(
      this.id, this.product, this.quantity, this.pricerPerKg, this.image);
  factory ProductItem.fromJson(Map<String, dynamic> json) {
    return ProductItem(json["_id"], Product.fromJson(json["product"]),
        json["quantity"], json["price_per_kg"] / 1, json["image"]);
  }
}
...
class IngridentItem {
  ...
  String? image;
  IngridentItem(
      this.id, this.ingredients, this.quantity, this.pricerPerKg, this.image);
...
class Store {
  ...
  List<MachineryItem> machineryItems;
  List<IngridentItem> ingredientItems;
